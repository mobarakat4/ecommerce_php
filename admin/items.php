...
if(isset($_SESSION['username']))
{
    ...
    switch ($do){
        case 'manage':
            ...
            ?>
            <div>
                <h1 class="text-center head-manager rounded container-md">Manage Items</h1>
            </div>
        ...
        case 'add':
            ...
            <div class="container ">
                ...
                <form action="?do=insert" method="post" class="m-auto ">
                    <div class="form-group  mb-4"><label for="name" class=" text-center form-label ">Name</label><div class ="mx-md-5 "><input placeholder="Name of the item" autocomplete="off" class="form-control" type="text" name="name"  required='required'><span></span></div></div>
                    <div class="form-group  mb-4"><label for="fullname" class="text-center form-label">Description</label><div class =" mx-md-5 "><input placeholder="description of the item" autocomplete="off" class="form-control" type="text" name="desc" ><span></span></div></div>
                    <div class="form-group  mb-4"><label for="fullname" class="text-center form-label">Price</label><div class =" mx-md-5 "><input placeholder="Price of the item" autocomplete="off" class="form-control" type="text" name="price" required='required'><span></span></div></div>
                    <div class="form-group  mb-4"><label for="fullname" class="text-center form-label">Country</label><div class =" mx-md-5 "><input placeholder="country of made the item" autocomplete="off" class="form-control" type="text" name="country" required='required'><span></span></div></div>
                    ...
                    <div class="form-group  mb-4 ">
                        ...
                        <div class =" mx-md-5  row">
                            <select class=" form-control form-select form-select-sm" style="width:2000px;" name="member">
                                <option >Select</option>
                                <?php
                                    $rows=select('*','users');
        ...
        case 'insert':
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                if(!checkselect('name','items',$_POST['name']))
                {
                        ...
                        $stmt=$db->prepare("insert into items(name,description,price,country_made,status,member_id,cat_id,date) values(?,?,?,?,?,?,?,now())");
                        $stmt->execute(array($name,$desc,$price,$country,$status,$member,$item));
                        $count=$stmt->rowCount();
